...
const phraseDetails =
  "Les rictus volontaires sont souvent considérés comme une représentation humoristique exagérée d'une émotion. ";

const typingText2 = document.getElementById("typing-text2");

const phraseDetails2 =
  "Dans les arts, le rictus a grandement influencé les mouvements sombres de l'art. Le rictus a souvent été utilisé pour représenter les émotions sombres et négatives de l'existence humaine, en particulier pour mettre en valeur la souffrance psychologique et les émotions intenses de l'homme. ";
...
function typeWriter() {
  ...
  wordElement2.addEventListener("click", function () {
    console.log("Mot cliquer !"); // videoRoller.src = "../video/Chapitre1-Art-V2.mp4";
