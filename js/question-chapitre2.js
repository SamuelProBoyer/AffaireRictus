...
function typeWriterPlus() {
  if (typingText.style.display === "block" && interaction2Writing === false && interaction3Writing === false) {
...
function typeWriterPlus2() {
  if (typingText2.style.display === "block" && interaction1Writing === false && interaction3Writing === false) {
...
function typeWriterPlus3() {
  if (typingText3.style.display === "block" && interaction1Writing === false && interaction2Writing === false) {
