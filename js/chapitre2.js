      ...
      const phraseDetails = "Le rictus sardonique est une contraction musculaire qui affecte principalement les muscles de la mâchoire et du cou, ce qui donne une expression faciale tordue et souriante. Cette forme de rictus est souvent associée à la tétanie, une affection qui provoque des spasmes musculaires généralisés. "
      ...
      const phraseDetails2 = "Le rictus de la maladie de Parkinson est une contraction musculaire qui affecte les muscles du visage, ce qui donne une expression faciale figée et sans émotion. Cela est dû à un déficit en dopamine, une substance chimique qui permet la communication entre les cellules nerveuses, qui est caractéristique de la maladie de Parkinson. "
      ...
      const phraseDetails5 = "Il y a plusieurs effets secondaires indésirables, tels que la somnolence, la confusion, la bouche sèche, la constipation, la prise de poids ou la diminution de la libido. Consulter un expert de la santé est la meilleure option pour avoir conscience de toutes les répercussions. "
